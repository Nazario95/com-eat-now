...
import {getFirestore, collection, getDocs, doc} from "https://www.gstatic.com/firebasejs/10.4.0/firebase-firestore.js";
...
//ACCESS DB CONFIG
  ...
  const resraurantesRef = collection(db, "galambo");


  const querySnapshot = await getDocs(resraurantesRef, "adminuser");

  querySnapshot.forEach((doc) => {
    console.log(doc.data().pswa);
  });