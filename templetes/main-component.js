...
function componentesMenus(){
    //CREANDO DATOS DE LOS COMPONENTES SLIDER DE COMIDADS Y RESTAURANTES
    const datosComponentes = [{
        ...
        {
            classContainer:`tarjeta componente-tarjeta d-block`,
    ...
    for(let i=0;i<numeroComponenetes; i++){
        ...
        let tituloComida = document.createElement('p');
