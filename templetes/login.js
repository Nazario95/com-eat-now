//Comprobar el entorno de ejecucion de la pagina
//CODIGO DE SEGURIDAD, SE EJCUTARA SOLO SI HAY UNA SESION ACTIVA
...
const closeModalBtn = entornoEjecucion;

const formLogin = `
<form class="form_container">
    ${closeModalBtn}
    <div class="title_container">
    <p class="title usuario-activo">Inicia Sesion</p>
    <span class="subtitle">Inicia Sesion a la pagina para ver todo el contenido y las funcionalidades de la misma.</span>
    </div>
    <br>
    ...
    <input placeholder="correo@mail.com" type="email" class="input_field datos-login" id="email_field" required>
    </div>
    <div class="input_container">
    ...
    <input placeholder="Contraseña"  type="password" class="input_field datos-login" id="password_field" required>
    </div>
    ...
    <div class="create-count">
        <a href="create-user.html" class="color_fff">
            Crear Cuenta
        </a>
     </div>
    ...
    <span>Inciar Sesion con Google</span>
    </button>
    ...
    <span>Inicia Sesion con tu Apple ID</span>
    </button>
...
const modalLogin = `
<a class="nav-link iniciar-sesion" href="#" data-bs-toggle="modal" data-bs-target="#staticBackdrop">Iniciar Sesion</a>
